...
def find_phone_number (update: Update, context):
    ...
    phoneNumRegex = re.compile(r'(\b(8|\+7) \(\d{3}\) \d{3}-\d{2}-\d{2}\b|\b(8|\+7)\d{10}\b|\b(8|\+7) \(\d{3}\)\d{7}\b|\b(8|\+7) \d{3} \d{3} \d{2} \d{2}\b|\b(8|\+7) \(\d{3}\) \d{3} \d{2} \d{2}\b|\b(8|\+7)-\d{3}-\d{3}-\d{2}-\d{2}\b)')
